...
function AddProduct() {
  ...
  return (
    <>
      <PageHeader className="ninjadash-page-header-main" title="Add Competition" routes={PageRoutes} />
      <Main>
        <Row gutter={15}>
          <Col xs={24}>
            <Cards headless>
              <Row gutter={25} justify="center">
                <Col xxl={12} md={18} xs={24}>
                  <AddProductForm>
                    <Form style={{ width: '100%' }} form={form} name="addCompetition" onFinish={handleSubmit}>
                      <BasicFormWrapper>
